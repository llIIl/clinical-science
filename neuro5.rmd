...
\includegraphics{images/neuro5-umn-lmn-signs.png}
...
Proceed with consultation: direct Q at pt, ask to have a chat with husband

Dx: can get advanced health directive, clin trials, gives pt time to do stuff before dying, interventions can help

Depression, dementia, delirium have to d/dx

## Trigger 2

Commonest causes of memory impairment: important to know ddx as some are treatable
...
Classification of dementia: 4 main types = {alzheimers, lewy body (concentration, distances, *visual hallucinations, parkinsonism, fluctuation in mental state*), vascular (step deterioration, sudden onset), frontotemporal}

Specific cognitive tests:

-  MMSE: out of 30, few questions testing working, visualspacial awareness,... Below 28 get concerned. This is biased
-  GPCOG: piece of paper for both pt and their SO

Ex and Ix: to mainly rule stuff out
...
Aged care assessment, talk to both people at once, discuss prognosis, mental exercises

## Trigger 4

Medications: cholinesterase inhibitors, NMDA-R antagonists, symptomatic stuff for sleeping, craziness, antidepressants
