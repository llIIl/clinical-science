...
-  Calculi:
    -  Struvite likely to be from infn (such as *Proteus*)
...
-  Nociceptive (pain due to nociceptors detecting tissue damage. Can be blocked with NSAIDS, opiods; sharp, burning) vs neuropathic (irritated/diseased nerves e.g. peripheral/autoimmune/diabetic neuropathy or obstructions; described as tingling, burning, pins and needles)
...
Risks of catheterisation: urosepsis (septicaemia due to infection in the genitourinary system)
...
Neurogenic bladder: problems with the nervous system causing urinary retention / incontinence. Have to empty this to prevent stasis $\rightarrow$ infn.
...
Mechanism for dizziness when straining to void: increasing abdominal pressure $\rightarrow$ stimulation of vagal nerve $\rightarrow$ micturition syncope (emptying large amounts of V from bladder).
...
Paediatrics is like veterinary science $\rightarrow$ have to ask random q's since child can't explain things themselves. \textbf{Always ask more and examine more in children}.

Conditions not to miss in a febrile child (potentiall fatal or life altering)

-  Ca
-  Septic shock
-  Meningococcal disease (Neiserria meningitis (gram neg coccus); meningitis): neck stiffness/rigidity, fever, koenig's sign, Brudzinski's sign (more for adults), rash (late sign; caused by septic emboli getting into tissue and causing microinfarctions $\rightarrow$ non-blanching rash which separates it from dermal rashes), decreased level of consciousness
