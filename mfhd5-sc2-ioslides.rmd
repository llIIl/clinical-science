...
-  [Use this reading for full info](http://www.cancerscreening.gov.au/internet/screening/publishing.nsf/Content/C2058A7D155867ACCA2581C400082790/$File/CAN174-Understanding-the-National-Cervical-Screening-Program-Management-Pathway.pdf)
...
-  Current: occurs every 5 years. HPV testing uses partial genotyping to classify into oncogenic HPV 16/18 OR oncogenic HPV not-16/18. If HPV positive, then reflex LBC (liquid based cytology: placing the cervical sample in liquid suspension, rather than directly applying the sample on a microscope slide like a conventional Pap test) performed.
-  <img src="images/mfhd5-risk-cervical-ca.png" width="400" />

## Questions (cont.)

-  Purpose: to prevent cancer by detecting early and treating early
...
-  **Who is eligible/should be targeted for screening**
  -  Anyone with a cervix (inc transgender men, intersex, females,...), 25 to 74 years, asymptomatic/symptomatic (e.g. abnormal vaginal bleeding, unusual vaginal discharge, dyspareunia)/pregnant
  -  Self collecting: 30 years or older, cannot be/think they are pregnant, declined to have cervical sample taken by clinician, and either 1) overdue by 2 or more years, 2) have never screened
-  **What are some reasons for women not taking up cervical screening?**
-  Don't want to, low access to health services, don't know about it
...
-  Vaginal bleeding, contact bleeding, loss of appetite, weight loss, fatigue, pelvic/back/leg pain, bone fractures
...
-  Language differences: refer to a clinician that speaks the language, use an interpreter, show the pamphlets in other language
-  Cultural differences: cultural sensitivity courses


## Collecting a sample

-  **How in practice is the cervical sample actually taken? How would you explain this to a patient?** [geekymedic is a great resource for OSCE stuff](https://geekymedics.com/cervical-smear-test/)
1.  After the patient is prepared and comfortable, begin the speculum examination by examining the external genitalia for any abnormalities
2.  Inspect cervix
3.  The objective of cervical screening is to sample cells from the transformation zone of the cervix, where HPV is present and cell abnormalities that precede the development of squamous cell carcinoma are usually found
4.  After, or before, the sample has been collected, record the patient name, DOB and ID number on the specimen vial and any other patient identifiers required by the laboratory, and fill out pathology request form
5.  After sample collection, ensure the details of the consultation and procedure are accurately documented in the patient’s clinical record
...
-  Increased medical terminology knowledge, better understanding of language, covered under insurance and other legal stuff, confidentiality
...
-  **Do you understand the terms ‘endocervix’, ‘transformation zone’, and ‘ectropion’?** [this site more info](https://www.gfmer.ch/ccdc/pdf/module1.pdf)
-  **How does the transformation zone ‘move’ throughout reproductive life?**
-  Cervix = ectocervix (visible during speculum exam) + endocervix
-  Endocervix: luminal cavity within the cervix forming a passageway between the external os and the internal os. Lined by simple columnar cells that secrete mucous
-  Ectocervix lined by simple non-keratinizing stratified squamous epithelium
-  The squamocolumnar junction (SCJ): junction between the squamous epithelium and the columnar epithelium. Located at the external os pre-puberty, repro age is variable, post menopausal the SCJ is not visible and has receded into the endocervix.
-  Ectropion: eversion of squamocolumnar junction and large portions of columnar epithelium onto the ectocervix. This is not an abnormality and it can be caused by things such as hormonal changes, taking the OCP, pregnancy. However it is indistinguishable from early cervical cancer. When the everted columnar epithelium is exposed to acidic vaginal environment => squamous metaplasia => stratified squamous
-  Transformation zone (TZ): cervical area between the old SCJ and new SCJ. >90% of precancerous lesions begin here

## Questions (cont.)

-  **What is colposcopy? Why and when is this necessary?**
-  The cervix is inspected and acetic acid is applied to its surface – abnormal cells have increased surface proteins, which are coagulated by the acid and turn white, producing “acetowhite” areas which can be biopsied for histological assessment. Necessary: see above table
...
-  Now it is every 5 years instead of 2 years (this is fine as the development is so slow), cheaper and safer, and pap cytology has been replaced by HPV molecular genotyping test
...
-  Gardasil targets 16/18, cervical cancer can also be caused by non-HPV 16/18 (25%) and non-HPV related (5%)
