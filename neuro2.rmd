...
-  UMN => increased external sphincter tone
-  LMN => bowel cannot physically move the stool along so it gets stuck
...
-  Anterolateral tract: spinothalamic (pain and temp), spinoreticular, spinotectal = {pain, temperature, crude touch, firm pressure}
-  Dorsal lemniscal: check lecture 4 of this week (Bellingham)

## Trigger 4 

Pressure sores: pressure on area of tissue => lack of perfusion => anaerobic metabolism => tissue ischaemia. Spinal injuries: can't feel it.
...
High doses on muscle: fasciculations => inability to repolarise cell membranes => weakness + paralysis => ventilatory failure => 

## Trigger 3

Atropine: muscarinic antagonist. Actions would be the opposite of DUMBELS

Memorise the picture from the Eastern European lecturer. 
...
-  MSK: strain on erector spinae, infn of vertebrae, poor hip posture => functional scoliosis, spondylothesis (fracture), spondylitis, spinal stenosis, vertebral fracture, scoliosis, disc prolapse, osteomyelitis, epidural abscesses (IV drug users), OA
-  CVS: aortic aneurysm
