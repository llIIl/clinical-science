...
High doses on muscle: fasciculations $\rightarrow$ inability to repolarise cell membranes $\rightarrow$ weakness + paralysis $\rightarrow$ ventilatory failure $\rightarrow$ 
